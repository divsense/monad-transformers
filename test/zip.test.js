...
test ('StackT (StackT (ReaderT (WriterT (Either)))) zip', t => {
    ...
    const x = 
        Transformer
        .of      (11)
        .zip (Transformer.lift (T3.lift (T2.of (22))))
